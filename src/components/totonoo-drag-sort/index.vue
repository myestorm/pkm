<template>
  <div class="pkm-totonoo-drag-list" ref="dragList">
    <div class="pkm-totonoo-drag-item" draggable="true" v-for="(item, index) in modelValue" :key="index"
      :data-index="index"
...
export default defineComponent({
  ...
  setup (props, ctx) {
    ...
    const getDragTarget = (target: HTMLElement): HTMLElement => {
      return target.closest('.pkm-totonoo-drag-item') || target
    }
